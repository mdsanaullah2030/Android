...
import com.example.oneclass.Api.NotificationApi;
import com.example.oneclass.adapter.NotificationAdapter;
import com.example.oneclass.apiClient.ApiCient;
...
public class Notification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NotificationApi notificationApi = ApiCient.getRetrofit().create(NotificationApi.class);
